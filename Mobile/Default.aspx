<%@ Page Title="" Language="C#" MasterPageFile="~/Mobile/Layout.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="_4sqtransit.Mobile.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:Button ID="uxAuthorize" runat="server" Text="Log In with Foursquare"
    ...
    <div class="section">
        ...
        <p>
            ...
            to your phone whenever you check in near a transit stop on Foursquare. When 4sqtransit
            sees that you've checked in near a transit stop, it sends you a text message with
        ...
        <p>
            ...
            that, 4sqtransit will send you a text message anytime you check in within
            <%=ConfigurationManager.AppSettings["TransitStopRadius"]%>
            meters of a transit stop.</p>
    </div>
</asp:Content>
